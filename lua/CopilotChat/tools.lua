...
---@param query string
---@param data table<CopilotChat.config.tools.ResourceContent>
---@return table<CopilotChat.config.tools.ResourceContent>
...
---@return CopilotChat.config.tools.Content?
...
---@param resources table<CopilotChat.config.tools.ResourceContent>
---@return table<CopilotChat.Client.embed>
  ...
  if #resources < MULTI_FILE_THRESHOLD then
    return vim.tbl_map(function(item)
      return {
        ...
        name = item.uri,
        content = item.data,
        filetype = utils.mimetype_to_filetype(item.mimetype),
        start_line = 1,
      }
    end, resources)
  end
