...
---@class CopilotChat.client.Content
---@field type 'text' | 'resource' | 'error'
---@field data string
---@field source string

---@class CopilotChat.client.TextContent : CopilotChat.client.Content
---@field type 'text'

---@class CopilotChat.client.ResourceContent : CopilotChat.client.Content
---@field type 'resource'
---@field uri string
---@field mimetype string

---@class CopilotChat.client.ErrorContent : CopilotChat.client.Content
---@field type 'error'

---@class CopilotChat.config.tools.Tool
---@field description string?
---@field schema table?
---@field resolve fun(input: table, source: CopilotChat.source, prompt: string):table<CopilotChat.client.Content>
